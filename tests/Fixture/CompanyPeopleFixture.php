...
/**
 * CompanyPeopleFixture
 *
 */
class CompanyPeopleFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_visited' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'profile_id' => 1,
            'is_visited' => 1,
            'created' => '2016-08-09 21:44:55',
            'modified' => '2016-08-09 21:44:55'
        ],
    ];
}
