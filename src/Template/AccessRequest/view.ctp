		...
		<div class="row">
			<div class="col-md-5 col-md-offset-3">
				...
				<div class="box-body">
			      ...
			      <tr>
			      	<th><?= __('Perfil')?></th>
			      	<td><?= $this->element('action_profile', ['profileID' => $accessRequest->person->company_people[0]->profile->id]) ?></td>
			      </tr>
			      <tr>
		          <th><?= __('Puerta') ?></th>
...
<?php if (!empty($accessRequest->visit_profiles)): ?>
	<div class="row">
		<div class="col-md-12">
			<div class="box">
					<?= $this->element('VisitProfiles/visit_profile', ['visitProfile' => $accessRequest->visit_profiles[0]])?>
			</div>
		</div>
	</div>
<?php endif ?>	
