...
class SensorDataController extends AppController
{
	...
	public $controllerName = 'el Dato del sensor';
	/**
	 * Index method
	 *
	...
	public function index()
	{
		...
		$displayField = $this->SensorData->displayField();

		$this->set(compact('sensorData','displayField'));
	...
	public function add()
	{
		...
		if ($this->request->is('post')) {
			...
			if ($this->SensorData->save($sensorData)) {
				...
				$this->Flash->error(__('Los datos no han podido ser guardados. Por favor, intente nuevamente.'));
			}
		}
